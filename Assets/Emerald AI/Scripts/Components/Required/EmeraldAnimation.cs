...
namespace EmeraldAI
{
    ...
    public class EmeraldAnimation : MonoBehaviour
    {
        ...
        public void CheckAnimationStates()
        {
            ...
            //This is used to determine when an AI is in between combat and non-combat states. This stops undesired rotations that happens during these transitions and allows the mechanics to function much smoother. 
