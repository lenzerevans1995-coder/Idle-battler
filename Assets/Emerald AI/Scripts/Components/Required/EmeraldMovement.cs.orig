...
namespace EmeraldAI
{
    ...
    public class EmeraldMovement : MonoBehaviour
    {
        ...
        /// <summary>
        /// Checks various animation states to see if an AI can idle.
        /// </summary>
        bool CanIdle ()
        {
        ...
        /// <summary>
        /// Checks various animation states to see if an AI can move.
        /// </summary>
        bool CanMove ()
        {
        ...
        /// <summary>
        /// Checks various animation states to see if an AI can rotate while stationary.
        /// </summary>
        ...
        /// <summary>
        /// Checks various animation states to see if an AI can rotate while moving.
        /// </summary>
        ...
        void RotateAI()
        {
            ...
            if (!AnimationComponent.IsMoving && !AnimationComponent.IsDead && !RotateTowardsTarget || DestinationAdjustedAngle > 110)
            {
                ...
                {
                    //Once our AI has returned to its stationary position, adjust its position so it rotates to its original rotation.
        ...
        {
            //Edited
            if (m_NavMeshAgent.isOnOffMeshLink || !m_NavMeshAgent.enabled)
            {
